...
class GazeboModel(object):
    def __init__(self, gazebo_models_list):
        ...
        self._robots_models_twist_dict = {}
        ...
        for robot_name in self._gazebo_models_list:
            ...
            if robot_name_found:
                ...
                try:
                    ...
                    data_twist = data.twist[data_index]
                except IndexError:
            ...
            self._robots_models_twist_dict[robot_name] = data_twist
    ...
    def get_model_twist(self, robot_name):

        twist_now = None

        try:
            twist_now = self._robots_models_twist_dict[robot_name]
        except Exception as e:
            s = str(e)
            rospy.loginfo("Error, The _robots_models_twist_dict is not ready = " + s)
